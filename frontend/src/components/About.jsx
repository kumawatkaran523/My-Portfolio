...
function About() {
    ...
    useEffect(() => {
        if (location.hash === '#about-section-sm') {
            const element = document.getElementById('about-section-sm');
            if (element) {
    ...
    return (
        <>
            <section className='md:hidden h-screen m-2' id='about-section-sm'>
                <h2
                    class="text-3xl sm:text-[40px] relative z-10 font-bold px-4 py-2 mb-3 w-max mx-auto text-center bg-gradient-to-r from-purple-800 via-purple-600 to-purple-300 bg-clip-text text-transparent border-b-2 border-purple-600"
                >
                    About Me
                </h2>

                <div className="text-lg font-display text-center">
                    <span className='text-2xl flex justify-center items-center m-3'>Hey there ! <svg width="60px" height="60px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet">
                        ...
                        <g>
                            <path d="M6.83 77.34c1.41 2.76 2.88 5.32 4.59 7.58c1.7 2.26 3.65 4.18 5.92 5.43c1.1.61 2.41 1.14 3.69 1.54c1.29.41 2.63.69 4.01.88c2.76.34 5.66.28 8.73-.19c-2.38 2.07-5.56 3.17-8.8 3.41c-3.28.22-6.61-.49-9.59-2.17c-3-1.71-5.2-4.43-6.58-7.32c-1.38-2.91-2.12-6.04-1.97-9.16z" fill="#b0bec5"></path>
                            <path d="M16.28 76.17c.97 1.68 1.93 3.03 2.98 4.21c1.04 1.18 2.16 2.15 3.38 3.03c1.24.85 2.6 1.6 4.08 2.35c.74.38 1.53.68 2.31 1.12c.81.35 1.63.72 2.49 1.25c-.91.34-1.84.54-2.79.69c-.94.04-1.91.09-2.87-.04c-1.92-.26-3.84-.93-5.52-2.1c-1.65-1.19-3.02-2.84-3.77-4.71c-.76-1.86-.98-3.94-.29-5.8z" fill="#90a4ae"></path>
                        </g>
                    </svg></span>
